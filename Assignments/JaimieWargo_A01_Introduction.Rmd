...
This setting will help deal with relative paths later on... - From the Tool menu, select `Global Options` - Select the RMarkdown section - In the "Evaluate chunks in directory", set the option to "Project" (If you don't see this option, try restarting RStudio.)
...
> Answer: I have prior R experience from stats with Betsy, as well as research experience in undergrad (basic data wrangling and manipulation). This summer, I used lots of data analytics tools in Python for my internship. I do not have much experience with Git other than accessing other users' published files.

2.  Are there any components of the course about which you feel confident?

> Answer: I feel confident about the coding aspect and understanding the general logic of R.

3.  Are there any components of the course about which you feel apprehensive?

> Answer: I am apprehensive about the Git aspect, and I am still conceptualizing what an Rmd really is and the best use cases for it.
...
> Answer: <https://github.com/jaimiewargo/EDE_Fall2023>
