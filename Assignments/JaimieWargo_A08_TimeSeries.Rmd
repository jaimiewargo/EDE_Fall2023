...
```{r Set Up, warning=FALSE, echo=FALSE}
...
> Answer: The Seasonal Mann-Kendall test performed indicates that the ozone concentration has changed since 2010 (p-value = 0.0467).
