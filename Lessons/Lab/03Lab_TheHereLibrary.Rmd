...
And thus we introduce the `here` package, designed to streamline this process. We will not be using this option in class explicitly, but it is growing quite popular among R users. A more detailed description of the library and rationale can be found here: - Overview: <https://here.r-lib.org> & <http://jenrichmond.rbind.io/post/how-to-use-the-here-package/> - Github repo: <https://github.com/jennybc/here_here>
